...
import { CategoryType, ViewType } from "@/types/types";
  ...
  return (
    <div className="mr-1">
      ...
      <div className="pr-1 flex justify-start items-center gap-[10px] my-5 p-3 border-2 border-[#7D82B8] rounded-2xl">
        ...
        <Input placeholder="Поиск" type="text" onChange={(e) => setSearch(e.target.value)} name="search" id="search" className="border-2 border-[#7D82B8] focus:outline-none focus:border-[#E0C1B3]"/>
      </div>
